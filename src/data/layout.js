...
const WALLS_PLAN = [
  ...
  { id: 'W5', x0: 3.6, z0: 15.5, x1: 10.9, z1: 15.5, h: 3 },
  { id: 'W6', x0: 10.9, z0: 15.5, x1: 19.4, z1: 15.5, h: 1.8 },
  {
    id: 'W7',
    x0: 19.4,
    z0: 15.5,
  ...
  { id: 'W12', x0: 10.9, z0: 10.3, x1: 10.9, z1: 15.5, h: 3 },
  { id: 'W13', x0: 10.9, z0: 10.3, x1: 16.2, z1: 10.3, h: 3 },
  {
    id: 'W14',
    x0: 16.2,
    z0: 10.3,
...
const ROOMS_PLAN = [
  ...
  },
  {
    ...
    floor: 'gym',
    rects: [{ x0: 3.6, z0: 10.3, x1: 10.9, z1: 15.5 }],
  },
  {
    name: 'Tin shed',
    floor: 'dirt',
  ...
  },
  {
    ...
    floor: 'asphalt',
    rects: [
      { x0: 10.9, z0: 10.3, x1: 19.4, z1: 15.5 },
...
const ROOFS_PLAN = [
  { type: 'slab', x0: 3.6, z0: 10.3, x1: 10.9, z1: 15.5, y: 3.0, h: 0.15, mat: 'slab' },
